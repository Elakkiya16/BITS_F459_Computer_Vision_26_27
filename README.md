...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=34&duration=3000&pause=800&color=00D9FF&center=true&vCenter=true&width=700&lines=BITS+F459+%C2%B7+Computer+Vision;From+pixels+to+language+in+12+weeks;Build+it.+Verify+it.+Ship+it." alt="BITS F459 Computer Vision" />

### 🎓 BITS Pilani, Dubai Campus · First Semester 2026-27

![Weeks](https://img.shields.io/badge/weeks-12-00D9FF?style=for-the-badge&logo=googlecalendar&logoColor=white)
![Labs](https://img.shields.io/badge/labs-hands--on%20every%20week-FF6B6B?style=for-the-badge&logo=jupyter&logoColor=white)
![Python](https://img.shields.io/badge/python-3.10%2B-FFD93D?style=for-the-badge&logo=python&logoColor=black)
![PyTorch](https://img.shields.io/badge/PyTorch-2.x-EE4C2C?style=for-the-badge&logo=pytorch&logoColor=white)
![OpenCV](https://img.shields.io/badge/OpenCV-4.x-5C3EE8?style=for-the-badge&logo=opencv&logoColor=white)
![Status](https://img.shields.io/badge/status-Week%201%20loading…-6BCB77?style=for-the-badge)
...
```mermaid
%%{init: {'theme':'base','themeVariables':{'primaryColor':'#00D9FF','primaryTextColor':'#0b1220','lineColor':'#94a3b8','secondaryColor':'#FFD93D','tertiaryColor':'#FF6B6B'}}}%%
timeline
    title From pixels to language
    section 🧱 Classical (CLO1)
        Wk 1 : Images & preprocessing
        Wk 2 : Edges · corners · descriptors
        Wk 3 : Segmentation
    section 🧠 Learning (CLO2–3)
        Wk 4 : ML for vision
        Wk 5 : Neural networks
        Wk 6 : CNNs  →  MID-SEM
        Wk 7 : Transfer learning
    section 🚀 Modern deep vision (CLO4)
        Wk 8 : Object detection
        Wk 9 : Deep segmentation & foundation models
        Wk 10 : Motion · video · depth
    section 🎨 Generative & VLMs (CLO5)
        Wk 11 : Generative models
        Wk 12 : Vision–language & synthesis  →  COMPRE
```
...
![Visitors](https://img.shields.io/badge/see%20you%20in-Week%201-00D9FF?style=flat-square)
